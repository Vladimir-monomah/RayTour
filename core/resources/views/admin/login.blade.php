...
<!-- BEGIN LOGO -->
<div class="logo">
<a href="#"><img src="{{asset('frontend/images/logo.png')}}" alt="-" style="filter: brightness(0) invert(1);"/> </a>
</div>
<!-- END LOGO -->
...
{!! csrf_field() !!}
<button type="submit" class="btn green uppercase btn-block">Вход</button>
</div>
...
<div class="copyright"> {{ $yy }} © {{$general->sitename}}. </div>
